"""
Our output size from `get_state` is 38. In this, I only use `Close` and `Volume` parameters, you can choose any parameters you want from your DataFrame.
...
concat_parameters = np.concatenate(
    [get_state(parameters, 20), [[inventory_size, mean_inventory, capital]]], axis=1
)
...
plt.plot(df["Close"], color="r", lw=2.0)
plt.plot(
    df["Close"],
    "^",
    markersize=10,
